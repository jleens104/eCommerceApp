...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupans,
                         String productPrice, String cuttedPrice, int productQuantity,
                         int offersApplied, int coupansApplied) {
        this.type = type;
    ...
    public CartItemModel(int type, String totalItems, String totalItemPrice,
                         String deliveryPrice, String totalAmount,
                         String savedAmount ) {
