    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setCategoryIcon(String iconUrl) {
            if (!iconUrl.equals("null")) {
                Glide.with(itemView.getContext()).load(iconUrl).apply(new RequestOptions().placeholder(R.drawable.icon_placeholder_product)).into(categoryIcon);
            } else {
                categoryIcon.setImageResource(R.drawable.ic_baseline_home);
            }
        }
