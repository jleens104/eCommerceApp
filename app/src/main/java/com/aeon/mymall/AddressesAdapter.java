...
import static com.aeon.mymall.MyAccountFragment.MANAGE_ADDRESS;
import static com.aeon.mymall.MyAddressesActivity.refreshItem;
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData (String username, String userAddress, String userPincode, Boolean selected, int position)  {
            ...
            if (MODE == SELECT_ADDRESS){
                ...
                icon.setImageResource(R.drawable.icons8_menu_vertical);
