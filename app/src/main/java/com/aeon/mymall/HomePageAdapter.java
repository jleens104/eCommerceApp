...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        switch (homePageModelList.get(position).getType()) {
            case HomePageModel.BANNER_SLIDER:
                List<SliderModal> sliderModalList = homePageModelList.get(position).getSliderModalList();
    ...
    public class BannerSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        private List<SliderModal> arrangedList;
        ...
        private void setBannerSliderViewPager(final List<SliderModal> sliderModalList) {
            ...
            for (int x = 0; x < sliderModalList.size(); x++) {
                arrangedList.add(x, sliderModalList.get(x));
            }

            arrangedList.add(0, sliderModalList.get(sliderModalList.size() - 2));
            arrangedList.add(1, sliderModalList.get(sliderModalList.size() - 1));
            arrangedList.add(sliderModalList.get(0));
            arrangedList.add(sliderModalList.get(1));
    ...
    public class StripAdBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.icon_placeholder_banner)).into(stripAdImage);
            stripAdContainer.setBackgroundColor(Color.parseColor("#4374BB"));
        }
    }
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public GridProductViewHolder(@NonNull View itemView) {
            ...
            gridLayoutViewAllBtn = itemView.findViewById(R.id.grid_layout_view_all_btn);
        ...
        private void setGridProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, String title, String color) {
            ...
            for (int x = 0; x < 4; x++) {
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductImage())
                        .apply(new RequestOptions().placeholder(R.drawable.icon_placeholder_product)).into(productImage);
                ...
                if (!title.equals("")) {
                    final int finalX = x;
                    gridProductLayout.getChildAt(x).setOnClickListener(view -> {
